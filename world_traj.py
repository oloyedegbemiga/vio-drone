...
class WorldTraj(object):
    ...
    def __init__(self, world, start, goal):
        ...
        res_path = graph_search(world, self.resolution // 2, self.margin, start, goal, astar=True)
        ...
        if res_path is None or res_path[0].shape[0] < 17:
            ...
            for i in range(0, 15):
                print(i)
                curr += 0.045
                res_path = graph_search(world, self.resolution, curr, 1/start, goal, astar=True)
